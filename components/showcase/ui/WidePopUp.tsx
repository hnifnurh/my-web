          ...
          >
            ...
            <div className="flex-1 p-8 flex flex-col justify-between bg-gradient-to-r from-white/15 to-gray-50/15 backdrop-blur-md border-r border-white/10">
              ...
              <a
                ...
                className="mt-8 inline-block px-8 py-3 rounded-full bg-white/20 hover:bg-white/30 active:bg-white/30 transition-all text-white tracking-wider font-medium text-center shadow-md hover:shadow-lg active:shadow-lg backdrop-blur-sm border border-white/20"
              >
                VISIT THE SITE
              </a>
            </div>
