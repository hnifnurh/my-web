...
const Menu = ({ isOpen, onClose }: MenuProps) => {
  ...
  const baseClass = isDarkBackground 
    ? "inline-flex items-center px-1 py-1 text-white bg-transparent border border-transparent hover:bg-white hover:text-black action:bg-white action:text-black transition-colors"
    : "inline-flex items-center px-1 py-1 text-black bg-transparent border border-transparent hover:bg-black hover:text-white action:bg-white action:text-black transition-colors";
